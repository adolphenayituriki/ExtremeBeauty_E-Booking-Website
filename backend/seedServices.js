...
const services = [
  ...
  { name: 'Microshading Eyebrows', price: 100000, priceFormatted: 'RWF 100,000', image: '/images/Ombr%C3%A9,%20microshading.jpg', category: 'Brows', description: 'A soft, powdered effect technique using tiny dots to create a filled-in, makeup-like finish.', featured: true, active: true, order: 1 },
  ...
  { name: 'Hybrid Set', price: 50000, priceFormatted: 'RWF 50,000', image: '/images/Hybride%20set.jpg', category: 'Lashes', description: 'A mix of classic and volume techniques creating a textured, wispy look.', featured: false, active: true, order: 6 },
  ...
  { name: 'Mega Volume Set', price: 60000, priceFormatted: 'RWF 60,000', image: '/images/Mega%20volume.jpg', category: 'Lashes', description: 'Ultra-dramatic look using the finest fans of 6-16 lashes per natural lash.', featured: false, active: true, order: 8 },
  ...
  { name: 'Lash Removal', price: 5000, priceFormatted: 'RWF 5,000', image: '/images/Lash%20removal.jpeg', category: 'Lashes', description: 'Professional and safe removal of eyelash extensions protecting your natural lashes.', featured: false, active: true, order: 10 },
