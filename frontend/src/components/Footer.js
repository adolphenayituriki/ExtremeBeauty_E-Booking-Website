          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <ul className="space-y-3">
              {[
                ...
                { icon: <FiMapPin size={12} />, value: site.address.split(',')[0] || site.address, sub: site.address, href: site.mapsUrl, external: true, mapsIcon: true },
                ...
                <li key={i}>
                  <a href={item.href} target={item.external ? '_blank' : undefined} rel={item.external ? 'noopener noreferrer' : undefined} className="text-gray-500 text-[0.78rem] hover:text-gold transition-colors duration-200 flex items-start gap-2.5">
                    ...
                    <div>
                      <p className="text-white text-[0.78rem] flex items-center gap-1.5">
                        {item.value}
                        {item.mapsIcon && (
                          <a
                            href={site.mapsUrl}
                            ...
                            className="w-5 h-5 bg-white/[0.06] border border-white/10 rounded-md flex items-center justify-center text-gold hover:bg-gold hover:text-black hover:border-gold transition-all duration-200 cursor-pointer"
                          >
