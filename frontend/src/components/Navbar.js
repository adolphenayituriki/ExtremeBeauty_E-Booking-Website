      ...
      <div className={`fixed top-0 w-full z-50 text-[0.68rem] hidden lg:block transition-all duration-500 ${scrolled ? 'opacity-0 -translate-y-full pointer-events-none h-0' : 'opacity-100 translate-y-0 h-[30px]'}`}>
        ...
        <div className="relative flex items-center justify-between px-6 lg:px-10 h-[30px] max-w-[1400px] mx-auto text-gray-400">
          <div className="flex items-center gap-5">
            ...
            <a href="mailto:info@extremebeauty.rw" className="flex items-center gap-1.5 hover:text-gold transition-colors duration-200">
              <FiMail size={10} /> info@extremebeauty.rw
            </a>
            <span className="flex items-center gap-1.5">
              <FiMapPin size={10} /> 105 KG 9th Ave, Nyarutarama, Kigali
            </span>
          </div>
          <div className="flex items-center gap-4">
            <a href="https://instagram.com/extreme_beauty.rw" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition-colors duration-200" aria-label="Instagram">
              <FiInstagram size={12} />
            </a>
        ...
        <div className={`absolute top-0 right-0 h-full w-full max-w-sm glass shadow-[-10px_0_40px_rgba(0,0,0,0.1)] transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] flex flex-col ${mobileOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          ...
          <div className="flex-1 flex flex-col px-6 pb-6 overflow-y-auto">
            ...
            <div className="mt-auto pt-5 border-t border-gray-100 flex gap-3">
              <a href="https://instagram.com/extreme_beauty.rw" target="_blank" rel="noopener noreferrer" className="w-9 h-9 border border-gray-200 flex items-center justify-center text-gray-400 hover:bg-gold hover:text-white hover:border-gold transition-all duration-300 rounded-xl">
                <FiInstagram size={15} />
              </a>
              <a href="tel:+250785069349" className="w-9 h-9 border border-gray-200 flex items-center justify-center text-gray-400 hover:bg-gold hover:text-white hover:border-gold transition-all duration-300 rounded-xl">
                <FiPhone size={15} />
              </a>
              <a href="https://wa.me/250785069349" target="_blank" rel="noopener noreferrer" className="w-9 h-9 border border-gray-200 flex items-center justify-center text-gray-400 hover:bg-[#25D366] hover:text-white hover:border-[#25D366] transition-all duration-300 rounded-xl">
