...
export const allCategories = [
  {
    ...
    services: [
      ...
      { name: 'Ombré, microshading', description: 'A soft, powdered effect technique using tiny dots to create a filled-in, makeup-like finish.', image: '/images/Ombr%C3%A9,%20microshading.jpg', price: 'RWF 100,000', fit: 'contain' },
